export { default as close } from "./close__icon.svg";
export { default as menu } from "./menu__icon.svg";
export { default as discount } from "./discount__icon.svg";
export { default as robot } from "./robot__img.png";
